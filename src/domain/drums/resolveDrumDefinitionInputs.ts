...
const LABELS: Record<DrumInputKey, string> = {
  dr_kick_1_out: "Kick 1 Out",
  dr_kick_1_in: "Kick 1 In",
  ...
  dr_oh_r: "OH R",
  dr_pad_mono_sfx: "PAD",
  dr_pad_stereo_sfx_l: "PAD L",
  dr_pad_stereo_sfx_r: "PAD R",
  dr_pad_stereo_backing_l: "PAD L",
  dr_pad_stereo_backing_r: "PAD R",
  dr_tracks_l: "Tracks L",
  dr_tracks_r: "Tracks R",
};
